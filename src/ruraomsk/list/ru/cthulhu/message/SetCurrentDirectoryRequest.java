 ...
 */
public class SetCurrentDirectoryRequest extends BaseMessage
{
    Name32 DirName= new Name32();
    public SetCurrentDirectoryRequest()
    {
        itsRequest();
        setId(Util.SetCurrentDirectory);
        setVersion(Util.CT_V23);
    }
    public SetCurrentDirectoryRequest(String DirName)
    {
        itsRequest();
        setId(Util.SetCurrentDirectory);
        setVersion(Util.CT_V23);
