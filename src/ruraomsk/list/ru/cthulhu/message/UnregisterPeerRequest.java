 ...
 */
public class UnregisterPeerRequest extends BaseMessage
{
    byte RegStage;
    int DevCPID;
    InetAddress NSIP;
    ...
    public UnregisterPeerRequest(int DevCPID, InetAddress NSIP, InetAddress NSNetMask, int NSPort)
    {
        itsRequest();
        setId(Util.UnregisterPeer);
        setVersion(Util.CT_V23);
    ...
    public UnregisterPeerRequest(int SourceData, int ConvertedData)
    {
        itsRequest();
        setId(Util.UnregisterPeer);
        setVersion(Util.CT_V23);
